...
import com.hoang.process.ProcessVideo;
...
public class LinkVideo {
    ...
    public final static String url = "https://drive.google.com/get_video_info?docid=";

    @Autowired
    private RestTemplate restTemplate;

    @RequestMapping(value = "/getListLink", method = RequestMethod.GET)
    public String getListLink(@RequestParam(value = "docId") String docId) throws UnsupportedEncodingException {
